...
* The following dependencies are not known to work with Spring Native: 'Spring Web Services, Spring Boot DevTools, Rest
  Repositories, Spring Session'. As a result, your application may not work as expected.
